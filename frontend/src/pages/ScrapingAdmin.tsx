                        ...
                        <button
                          onClick={() =>
                            createJob.mutate({
                              ...
                              ...(j.prefecture_code && { prefecture_code: j.prefecture_code }),
                            })
                          }
                          disabled={createJob.isPending}
                          className="px-2.5 py-1 bg-amber-600 text-white rounded-md hover:bg-amber-700 text-xs font-medium disabled:opacity-50 transition-colors"
                        >
                          Retry
                        </button>
                      )}
